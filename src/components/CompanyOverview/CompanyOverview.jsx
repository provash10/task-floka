  ...
  return (
    <div className='flex flex-col lg:flex-row gap-6 p-4 bg-gray-200'>
      ...
      <div className='w-full lg:w-[60%] relative flex justify-center'>
        ...
        {/* Sentence inside image, bottom 20% */}
        <div className='absolute bottom-[20%] left-1/2 transform -translate-x-1/2 text-center px-4 w-full lg:w-[90%]'>
