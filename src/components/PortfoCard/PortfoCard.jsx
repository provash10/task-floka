...
const PortfoCard = () => {
    return (
        <div>
            ...
            <div>
                <div className='relative '>
                    <img className='rounded-2xl' src="https://floka.casethemes.net/wp-content/uploads/2025/05/home1-bg-img3-1320x600.webp" alt="" />
                    ...
                    <h1 className='absolute left-4 top-135 text-white'>BRANDING, UX</h1>
                </div>
            ...
            <div className='flex justify-between gap-4 rounded-2xl mb-2'>
                <div className='relative'>
                    <img className='rounded-2xl' src="	https://floka.casethemes.net/wp-content/uploads/2025/05/home1-bg-img2-655x450.webp" alt="" />
                    <img className='absolute top-2 left-2 p-4' src="https://floka.casethemes.net/wp-content/uploads/2025/05/home-1-icon7.svg" alt="" />
                    <h1 className='absolute left-4 top-100 text-white'>BRANDING, UX</h1>
                </div>

                <div className='relative'>
                    <img src="https://floka.casethemes.net/wp-content/uploads/2025/05/home1-bg-img1-655x450.webp" alt="" />
